...
public extension ComponentDescriptor {
    ...
    enum ButtonPreset {
        ...
        public static func filled(
            ...
            func content(bg: UIColor, contentAlpha: CGFloat) -> ComponentDescriptor {
                .stack(.init(
                    common: .init(
        ...
        private struct SizeConfig {
            ...
            init(for size: Size) {
                ...
                case .small:
                    ...
                    margins = UIEdgeInsets(top: .xs, left: .s, bottom: .xs, right: .s)
                case .medium:
                    height = 44
                    ...
                    margins = UIEdgeInsets(top: .s, left: .m, bottom: .s, right: .m)
                case .large:
                    height = 50
                    ...
                    margins = UIEdgeInsets(top: .m, left: .l, bottom: .m, right: .l)
                }
            }
        }
    }
