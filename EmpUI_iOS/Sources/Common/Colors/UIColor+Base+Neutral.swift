...
public extension UIColor.Base {
    ...
    static let neutralInverted900 = UIColor { $0.userInterfaceStyle == .dark ? UIColor(hex: 0xFAFAFA) : UIColor(hex: 0xFFFFFF) }
    static let neutralInverted500 = UIColor { $0.userInterfaceStyle == .dark ? UIColor(hex: 0xD4D4D4) : UIColor(hex: 0xE5E5E5) }
}
