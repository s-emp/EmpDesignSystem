...
struct SemanticColorTests {
    ...
    func cardLavender() {
        #expect(UIColor.Semantic.cardLavender === UIColor.Base.lavender50)
    }

    @Test("cardBorderLavender ссылается на lavender200")
    func cardBorderLavender() {
        #expect(UIColor.Semantic.cardBorderLavender === UIColor.Base.lavender200)
    }

    @Test("textPrimary ссылается на neutral900")
    func textPrimary() {
        #expect(UIColor.Semantic.textPrimary === UIColor.Base.neutral900)
    }

    @Test("textSecondary ссылается на neutral500")
    func textSecondary() {
        #expect(UIColor.Semantic.textSecondary === UIColor.Base.neutral500)
    }

    @Test("textAccent ссылается на lavender500")
    func textAccent() {
        #expect(UIColor.Semantic.textAccent === UIColor.Base.lavender500)
    }

    @Test("actionPrimary ссылается на lavender500")
    func actionPrimary() {
        #expect(UIColor.Semantic.actionPrimary === UIColor.Base.lavender500)
    }

    @Test("actionSuccess ссылается на mint500")
    func actionSuccess() {
        #expect(UIColor.Semantic.actionSuccess === UIColor.Base.mint500)
    }

    @Test("actionDanger ссылается на rose500")
    func actionDanger() {
        #expect(UIColor.Semantic.actionDanger === UIColor.Base.rose500)
    }
}
