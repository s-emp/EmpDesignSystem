...
public final class EInfoCard: UIView, EComponent {
    // MARK: - EComponent

    public private(set) var viewModel: ViewModel = ViewModel(subtitle: "", value: "")
    ...
    private func setup() {
        ...
        registerForTraitChanges([UITraitUserInterfaceStyle.self]) { (view: EInfoCard, _: UITraitCollection) in
